...
@ObjCClassName("BouncyIOS")
public class BouncyIOS extends NSObject implements UIApplicationDelegate {
	...
	public boolean applicationDidFinishLaunchingWithOptions(
		...
		this.app = new IOSApplication(new Bouncy(), config);
	...
	@Generated("NatJ")
	@Selector("alloc")
	public static native BouncyIOS alloc();

	@Generated("NatJ")
	protected BouncyIOS(Pointer peer) {
		super(peer);
	}
	
	@Selector("init")
	public BouncyIOS init() {
		super.init();
		return this;
	}
